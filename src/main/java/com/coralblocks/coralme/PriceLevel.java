...
public class PriceLevel {
	...
	private void removeOrder(Order order) {
		...
		// no need to remove listener here because the order object clears its listeners
		// when it is recycled
	}
	...
	private final class InternalOrderListener implements OrderListener {
		...
		@Override
		public void onOrderReduced(long time, Order order, long canceledSize, long newTotalSize,
